...
$("#ardoraMain").append("<div id='"+imaN+"' class='photoMG'><img src='Inicio_resources/media/imaMG/" + fileIma[num-1] + "'/></div>");
...
$("#"+imaN).append("<img src='Inicio_resources/media/imaMG/" + fileIma[num-1] + "'/>");
}else{
$("#"+imaN+ " img").remove();
if (conType[num-1]=="0"){
...
$("#ardoraMain").append("<div id='imaFull'><img alt='"+altIma[num - 1]+"' src='Inicio_resources/media/imaFull/f_" + fileIma[num-1].substring(2) + "'/></div>");
cssColors();
...
$("#imaFull").append("<img alt='"+altIma[num-1]+"' src='Inicio_resources/media/imaFull/f_"+fileIma[num-1].substring(2)+"'/>");
...
if ($.trim(fileMP3[num-1])){sourceLine=sourceLine+"<source src='Inicio_resources/media/"+fileMP3[num-1]+"' type='audio/mp3' />";}
if ($.trim(fileOgg[num-1])) {sourceLine=sourceLine+"<source src='Inicio_resources/media/"+fileOgg[num-1]+"' type='audio/ogg' />";}
...
sourceLine=sourceLine+"<source src='Inicio_resources/media/"+fileMP3[num-1]+"' type='audio/mp3' />";}
if ($.trim(fileOgg[num-1])) {
sourceLine=sourceLine+"<source src='Inicio_resources/media/"+fileOgg[num-1]+"' type='audio/ogg'/>";}
